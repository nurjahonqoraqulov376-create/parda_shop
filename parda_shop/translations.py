...
UI = {
    'uz': {
        ...
        'dash.agent_attach': 'Rasm biriktirish',
        'dash.agent_image_note': 'Shu rasm yozuvga biriktiriladi.',
        'dash.agent_image_bad': 'Rasmni qabul qilib bo‘lmadi.',
    ...
    'ru': {
        ...
        'dash.agent_attach': 'Прикрепить фото',
        'dash.agent_image_note': 'Это фото будет прикреплено к записи.',
        'dash.agent_image_bad': 'Не удалось принять фото.',
